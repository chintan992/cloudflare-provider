...
async function run() {
    const provider = new YFlixProvider();
    ...
    fs.writeFileSync('output-yflix.json', JSON.stringify({ movie: movieResults, tv: tvResults }, null, 2));
    console.log('Results written to output-yflix.json');
}
